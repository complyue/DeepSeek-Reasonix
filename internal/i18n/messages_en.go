...
Usage:
  ...
  reasonix config compact-ratio [--local] [10..95]        configure automatic compaction threshold
  reasonix config snip-ratio [--local] [5..95]             configure stale-tool-result cleanup threshold
